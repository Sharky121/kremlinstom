    ...
    '$window', function($window) {
      return {
        ...
        template: function(el, attrs) {
          ...
          itemTpl = el.html() || 'views me: {{item | json}}';
    ...
    return {
      ...
      controller: function($scope) {
        ...
        makeMessage = function(idn) {
          var m;
          switch(idn){
            case 'required': m = 'заполните поле'; break; 
            case 'goodlogin': m = 'логин занят'; break; 
            case 'checklogin': m = 'проверка логина...'; break; 
            case 'pwmatch': m = 'пароли не совпадают'; break; 
            case 'email': m = 'некорректный email'; break; 
            case 'number': m = 'некорректное число'; break; 
            case 'max': m = 'слишком большое число'; break; 
            case 'min': m = 'слишком маленькое число'; break; 
          }
          return m;
        };
