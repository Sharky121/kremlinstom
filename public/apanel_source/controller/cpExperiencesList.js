    ...
    angular.module('app')
        ...
        'experiencesList', [
            '$scope', '$TreeDnDConvert','$http','toaster','$routeSegment','$location','$timeout','errorShow','options', function ($scope, $TreeDnDConvert,$http,toaster,$routeSegment,$location,$timeout,errorShow,options) {
                ...
                $scope.link_add="/workers/"+$routeSegment.$routeParams.worker+"/"+$scope.lk+"/new";
                $scope.link = "/"+$scope.lk+"/";
                $scope.link_get = 'apanel/model/list-'+$scope.lk+'/'+$routeSegment.$routeParams.worker;
                ...
                $scope.my_tree.edit = function (node,event) {
                    ...
                    $location.path("/workers/"+$routeSegment.$routeParams.worker+$scope.link+node.id+'/edit');
                    return false;
                };
