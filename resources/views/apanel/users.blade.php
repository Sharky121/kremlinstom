...
<script type="text/ng-template" id="tree-dnd-template-fetch.html">
    <div class="list-group-item text-info"
        ...
        <span  class="fa" ng-class="{'fa-eye text-success':node['public']==1, 'fa-eye-slash text-danger':node['public']==0}" aria-hidden="true"></span>
        ...
        <span ng-if="node['phone']">&nbsp;
            <i class="fa fa-phone" aria-hidden="true"></i>
            @{{ node['phone'] }}
        </span>
        <span ng-if="node['email']">&nbsp;&nbsp;
            <i class="fa fa-envelope-o" aria-hidden="true"></i> @{{ node['email'] }}
        </span>
