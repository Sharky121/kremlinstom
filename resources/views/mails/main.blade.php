    ...
    <tbody>
        <tr>
            <td style="">
                ...
                <br>
                <br>
                <span style="font-family:'RobotoRegular';font-size:18px;padding-left:10px;vertical-align:middle;margin-bottom:0px;margin-top:0px;color:rgba(225, 0, 92, 1);font-weight:600;">
                        Запись на прием
                    </span>
            </td>
        </tr>
...
<table bgcolor="white" style="width: 100%;border-collapse: collapse;margin-bottom: 10px;">
    <tbody>
        ...
        <tr>
            <td style="font-size:16px;color:rgba(225, 0, 92, 1);padding-bottom:10px;padding-top:10px;border-bottom:1px solid rgba(225, 0, 92, 1);font-family:'RobotoRegular;'">
                Почта: <span style="color:black;font-family:'RobotoRegular;'">{{$email}}</span>
            </td>
        </tr>

        <tr>
            <td style="font-size:16px;color:rgba(225, 0, 92, 1);padding-bottom:10px;padding-top:10px;border-bottom:1px solid rgba(225, 0, 92, 1);font-family:'RobotoRegular;'">
                Услуга: <span style="color:black;font-family:'RobotoRegular;'">{{$service}}</span>
            </td>
        </tr>
        <tr>
            <td style="font-size:16px;color:rgba(225, 0, 92, 1);padding-bottom:10px;padding-top:10px;border-bottom:1px solid rgba(225, 0, 92, 1);font-family:'RobotoRegular;'">
                Доктор: <span style="color:black;font-family:'RobotoRegular;'">{{$doctors}}</span>
            </td>
        </tr>

        <tr>
            <td style="font-size:16px;color:rgba(225, 0, 92, 1);padding-bottom:10px;padding-top:10px;border-bottom:1px solid rgba(225, 0, 92, 1);font-family:'RobotoRegular;'">
                Желаемая дата: <span style="color:black;font-family:'RobotoRegular;'">{{$date}}</span>
            </td>
        </tr>

        <tr>
            <td style="font-size:16px;color:rgba(225, 0, 92, 1);padding-bottom:10px;padding-top:10px;border-bottom:1px solid rgba(225, 0, 92, 1);font-family:'RobotoRegular;'">
               Удобное время: <span style="color:black;font-family:'RobotoRegular;'">{{$time}}</span>
            </td>
        </tr>
   </tbody>
</table>
