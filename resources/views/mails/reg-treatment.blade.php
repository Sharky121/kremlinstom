...
<table bgcolor="white" style="width: 100%;border-collapse: collapse;margin-bottom: 60px;">
    <tbody>
    <tr>
        <td style="font-size:16px;color:rgba(225, 0, 92, 1);padding-bottom:10px;padding-top:10px;border-bottom:1px solid rgba(225, 0, 92, 1);font-family:'RobotoRegular;'">
            Имя клиента: <span style="color:black;font-family:'RobotoRegular;'">{{$name}}</span>
        </td>
    </tr>
    <tr>
        <td style="font-size:16px;rgba(225, 0, 92, 1);padding-bottom:10px;padding-top:10px;border-bottom:1px solid rgba(225, 0, 92, 1);font-family:'RobotoRegular;'">
            Телефон клиента: <span style="color:black;font-family:'RobotoRegular;'">{{$tel}}</span>
        </td>
    </tr>
